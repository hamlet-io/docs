...
We also have an explicit membership configuration option which allows you to define a array of group ids in the order you want the executed

This features allows for deployments to be defined and controlled through the solution file
...
- **fileransfer** - A managed file transfer system, generally based on an SFTP or FTP style transfer
...
We will be extending this functionality too all application components in a future release
