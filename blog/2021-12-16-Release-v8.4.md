...
- **orphaned deployments are always first:** A bug around the orphaned deployment processing meant that they were not being found. This has now been resolved and orphaned deployments will now be processed before other deployments to ensure they don't cause issues when running updates.
